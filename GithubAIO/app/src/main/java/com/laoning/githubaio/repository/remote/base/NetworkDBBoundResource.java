 ...
 * @param <ResponseType>
 */
public abstract class NetworkDBBoundResource<ResultType, ResponseType> {
    ...
    @MainThread
    public NetworkDBBoundResource(AppExecutors appExecutors, boolean ignoreDB, boolean ignoreLoading) {
