...
//            holder.languageColor.setImageTintList(ColorStateList.valueOf(languageColor));
        ...
        if(hasOwnerAvatar){
            ...
            Glide.with(fragment).load(repository.getOwner().getAvatarUrl()).into(holder.ivUserAvatar);
        } else {
...
//                }
        ...
        holder.forkMark.setVisibility(repository.getFork() ? View.VISIBLE : View.GONE);
    }
}
